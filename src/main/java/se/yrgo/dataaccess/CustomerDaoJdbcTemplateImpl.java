...
public class CustomerDaoJdbcTemplateImpl implements CustomerDao {
    ...
    private static final String CREATE_CALL_SQL = "CREATE TABLE TBL_CALL (CALL_ID integer generated by default as identity(start with 1), CUSTOMER_ID VARCHAR(255) NOT NULL, CALL_DATE DATE NOT NULL, NOTES VARCHAR(255))";
